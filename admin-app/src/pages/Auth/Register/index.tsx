...
const Register: React.FC<RegisterProps> = ({ onUserRegistration, setShowRegistration }): ReactElement => {
        ...
        <form action="/api/user/register" method="post">
          ...
          <div className="buttons">
            <Button
              ...
              label="To sign in"
            />
            <Button type="button" onClick={() => onUserRegistration(username, password)} label="Sign up" />
          </div>
        </form>
      </div>
    </div>
