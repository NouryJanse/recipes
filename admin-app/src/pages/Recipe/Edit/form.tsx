...
const Form: React.FC<FormProps> = ({
    ...
    const [numberOfPersons, setNumberOfPersons] = useState(
        recipe && recipe.numberOfPersons ? recipe.numberOfPersons : 2,
    )
                ...
                <form className="" onSubmit={handleSubmit(onSave)} {...formRef}>
                    ...
                    <FieldContainer>
                        <div className="flex flex-row align-middle mb-6 justify-between">
                            ...
                            <Dropdown
                                ...
                                validation={{
                                    required:
                                        'Did you forget to fill in the course of your recipe?',
                                }}
                                register={register}
                    ...
                    <FieldContainer>
                        <Textarea
                            ...
                            validation={{
                                required:
                                    'Did you forget to fill in the description of your recipe?',
                            }}
                            register={register}
                            errors={errors.description}
                        />
