...
export { default as CreateIngredient } from '../pages/Ingredient/Create'
export { default as CreateRecipe } from '../pages/Recipe/Create'
export { default as Dashboard } from '../pages/Dashboard'
export { default as EditIngredient } from '../pages/Ingredient/Edit'
export { default as EditRecipe } from '../pages/Recipe/Edit'
export { default as IngredientDetail } from '../pages/Ingredient/Detail'
export { default as Ingredients } from '../pages/Ingredient/List'
export { default as Login } from '../pages/Login'
export { default as Ratings } from '../pages/Ratings'
export { default as RecipeDetail } from '../pages/Recipe/Detail'
export { default as Recipes } from '../pages/Recipe/List'
